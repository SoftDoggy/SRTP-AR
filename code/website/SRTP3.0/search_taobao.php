...
?>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <iframe src="<?php echo 'https://s.taobao.com/search?initiative_id=tbindexz_20170503&ie=utf8&spm=a21bo.50862.201856-taobao-item.2&sourceId=tb.index&search_type=item&ssid=s5-e&commend=all&imgfile=&q='.$row["name"].'&suggest=0_1&_input_charset=utf-8&wq=water+b&suggest_query=water+b&source=suggest' ?>" name="ifraRight" id="ifraRight" src="Main.aspx" frameborder="1"  scrolling="yes" width=600 height=320 ></iframe>
                </div>
                <div class="col-md-2"></div>
            </div>
          </div>
